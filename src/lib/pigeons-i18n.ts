...
export const pigeonsCopy = {
  ...
  en: {
    ...
    projects: { eyebrow: "Right now", title: "Our projects", intro: "We move forward one project at a time, taking the time needed to do things properly.", current: "Current project", exciTitle: "Preparing for an important exam without learning under pressure.", exciText: "EXCI helps people prepare for the French civic exam with practice questions, quizzes and personal progress tracking.", available: "Available on the web", soon: "iPhone and Android coming soon", cta: "Discover EXCI" },
  ...
  de: {
    ...
    projects: { eyebrow: "Aktuell", title: "Unsere Projekte", intro: "Wir gehen Projekt für Projekt voran und nehmen uns die Zeit, es richtig zu machen.", current: "Aktuelles Projekt", exciTitle: "Sich auf eine wichtige Prüfung vorbereiten – ohne unnötigen Lernstress.", exciText: "EXCI begleitet die Vorbereitung auf die französische Einbürgerungsprüfung mit Übungsfragen, Quizzen und persönlichem Lernfortschritt.", available: "Im Web verfügbar", soon: "iPhone und Android demnächst verfügbar", cta: "EXCI entdecken" },
